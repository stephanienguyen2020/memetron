        ...
        <div className="container max-w-[1600px] mx-auto px-4">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Archive of all resolved prediction markets</p>
              </div>
            </div>
          ...
          >
            {[
              ...
              >
                ...
                <div className="text-xl font-mono font-medium">{stat.value}</div>
              </div>
            ))}
          </motion.div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="text-sm text-muted-foreground">
              Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredBets.length)} of{" "}
