            ...
            <div className="absolute -top-4 -right-4 z-30">
              <div
                className={cn(
                  ...
                  "bg-green-500/20 backdrop-blur-sm  text-green-400"
                )}
              >
              ...
              {isEffectivelyResolved ? (
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                      className="flex-1 border-white/10 hover:bg-green-500/10 hover:text-green-400 transition-colors"
                    >
                      View Details
                    </Button>
                    <Button
                      variant="outline"
                      size="icon"
                      className="border-white/10 hover:bg-green-500/10 hover:text-green-400 transition-colors"
                    >
                ...
                <div className="flex items-center gap-2 pt-2">
                  <Link
                    ...
                    className="flex-1"
                  >
                    <Button className="w-full bg-gradient-to-r from-green-400 to-[#00ff00] hover:opacity-90 text-black font-medium">
                      Place Bet
                    </Button>
                  </Link>
                  <Button
